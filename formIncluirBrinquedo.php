...
<div class="nav-bar-fixed">
    ...
    <div align="center">
        <button type="submit" class="waves-effect waves-light btn-large purple lighten-1" name="cadBrinquedo" value="Cadastrar Brinquedo"><i class="material-icons left">toys</i>Cadastrar Brinquedo</button>
        </br></br>
